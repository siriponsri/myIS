...
**Result:** A4_PRODUCTION_TRANSFER_AND_SELECTION is completed; ArmIndex measured runs, Selection, and Final counters remain zero.
...
Status: **completed**. A4_PRODUCTION_TRANSFER_AND_SELECTION is completed; ArmIndex measured runs, Selection, and Final counters remain zero.
