...
**Result:** A5_FINAL_CONFIRMATION is completed; ArmIndex measured runs, Selection, and Final counters remain zero.
...
Status: **completed**. A5_FINAL_CONFIRMATION is completed; ArmIndex measured runs, Selection, and Final counters remain zero.
