...
|---|---|---|---|---|---|
| Active ArmIndex campaign | `control` | `engineering` | `control/campaigns/armindex-multiretriever-v2.yaml` | `0779c019d1cbdbf52747b0bae90eb31f739f0a10af23f6fcfab50012799aee93` | `validated` |
