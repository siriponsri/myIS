...
|---|---|---|---|---|---|
| Active ArmIndex campaign | `control` | `engineering` | `control/campaigns/armindex-multiretriever-v2.yaml` | `bbe2ab3cbe7f32ae31594560ddf78d3bb86710715377a40876abfe96ea2a536f` | `validated` |
...
| ArmIndex read-model fragment schema | `schema` | `engineering` | `schemas/armindex/read-model.v1.json` | `f97779630461e05cbdb80fa66b01d0ddbbe58b6a9266adc244f1faf97c3dcc61` | `validated` |
