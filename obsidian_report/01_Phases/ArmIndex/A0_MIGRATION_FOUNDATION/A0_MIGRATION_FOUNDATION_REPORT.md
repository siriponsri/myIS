...
|---|---|---|---|---|---|
| Active ArmIndex campaign | `control` | `engineering` | `control/campaigns/armindex-multiretriever-v2.yaml` | `1c03d7317c0c51882ecb58e1e21103e08d879d051967c6bc372558631e9248c6` | `validated` |
...
| ArmIndex read-model fragment schema | `schema` | `engineering` | `schemas/armindex/read-model.v1.json` | `431f248e714c50af194ee9cdbc197441a0a384b830f739943a87a93c8b4ff0f8` | `validated` |
