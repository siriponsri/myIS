...
| Task | Work | Status |
|---|---|---|
| [[A0.1]] | Repository and authority migration | complete |
| [[A0.2]] | Model and representation contract freeze | complete |
| [[A0.3]] | Projection and Research Brain migration | complete |
| [[A0.4]] | Synthetic compute-feasibility fixtures | planned |
