...
**Result:** A3_TRANSFER_COMPLEMENTARITY_AND_HARNESSOPT is completed; ArmIndex measured runs, Selection, and Final counters remain zero.
...
Status: **completed**. A3_TRANSFER_COMPLEMENTARITY_AND_HARNESSOPT is completed; ArmIndex measured runs, Selection, and Final counters remain zero.
