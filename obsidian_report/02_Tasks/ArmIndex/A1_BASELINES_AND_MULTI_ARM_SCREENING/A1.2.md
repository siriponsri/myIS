...
The A1.1 receipt anchors a validated A1.2 offline scaffold. ARM-01 bm25s rank parity was checked on synthetic CPU inputs; four public dense source revisions, critical artifact commitments, a hash-bound budget, and runtime-minimal allowlists were frozen. The v5 direct-base revision binds the official PyTorch linux/amd64 manifest and replaces active custom-image transfers with code, Linux wheelhouse, runtime-minimal models, and safe job manifests. The additive v6 correction remains synthetic-only. The additive v7 repair preserves two live engineering failures and repairs them through a fresh root, checksum-gated reuse, a hash-bound supplement, and bytecode suppression; any later instance continuation remains conditional on complete live evidence, budget, watchdog, clean protected boundary, and separate next-goal authorization. Launch remains false pending live preflight and explicit adoption.
...
|---|---|---|---:|---:|---|---|
| `owner_local_cpu_preflight_blocker_count`@0 | `engineering_preflight` | `A1.2` | `10` | `1` | `pending_owner_launch_checklist_items` | `owner_local_provider_closeout` |
| `vast_v2_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `16` | `1` | `frozen_live_owner_checklist_items` | `owner_local_provider_closeout` |
| `vast_v2_synthetic_worker_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `completed_synthetic_worker_processes` | `owner_local_provider_closeout` |
| `vast_v2_synthetic_parallel_launch_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `synthetic_workers_started_in_parallel` | `owner_local_provider_closeout` |
| `vast_v2_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `owner_local_provider_closeout` |
| `vast_v2_estimated_instance_hours_min`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `planning_estimate_not_authorization` | `owner_local_provider_closeout` |
| `vast_v2_estimated_instance_hours_max`@0 | `engineering_preflight` | `A1.2` | `4` | `1` | `planning_estimate_not_authorization` | `owner_local_provider_closeout` |
| `vast_v2_estimated_raw_worker_usd_min`@0 | `engineering_preflight` | `A1.2` | `1.2` | `1` | `planning_estimate_not_authorization` | `owner_local_provider_closeout` |
| `vast_v2_estimated_raw_worker_usd_max`@0 | `engineering_preflight` | `A1.2` | `2.4` | `1` | `planning_estimate_not_authorization` | `owner_local_provider_closeout` |
| `vast_v3_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `owner_local_provider_closeout` |
| `vast_v3_common_screen_hard_stop_usd`@0 | `engineering_preflight` | `A1.2` | `18` | `1` | `hard_stop_not_spend_authorization` | `owner_local_provider_closeout` |
| `vast_v5_direct_base_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `21` | `1` | `direct_base_live_preflight_checks` | `owner_local_provider_closeout` |
| `vast_v5_custom_local_docker_build_removed`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `active_direct_base_path` | `owner_local_provider_closeout` |
| `vast_v6_live_quote_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.656` | `1` | `quoted_complete_four_rtx3090_instance_not_spend_authorization` | `owner_local_provider_closeout` |
| `vast_v6_synthetic_preflight_only`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `live_correction_authorization_boundary` | `owner_local_provider_closeout` |
| `vast_v7_preserved_live_failure_count`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `preserved_same_instance_repair_failures` | `owner_local_provider_closeout` |
| `vast_v7_bytecode_suppression_required`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `fresh_same_instance_repair_root` | `owner_local_provider_closeout` |
| `vast_v8_preserved_live_failure_count`@0 | `engineering_preflight` | `A1.2` | `3` | `1` | `preserved_validation_complete_bundle_failure_history` | `owner_local_provider_closeout` |
| `vast_v8_validation_lineage_complete`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `frozen_bundle_historical_validator_lineage` | `owner_local_provider_closeout` |
| `vast_v9_required_lifecycle_control_count`@0 | `engineering_preflight` | `A1.2` | `6` | `1` | `hash_bound_execution_lifecycle_controls` | `owner_local_provider_closeout` |
| `vast_v9_implementation_validation_complete`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `additive_v9_runtime_and_orchestration_revision` | `owner_local_provider_closeout` |
| `vast_v9_live_arm_pass_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `four_synthetic_gpu_worker_arm_receipts` | `owner_local_provider_closeout` |
| `vast_v9_qwen_measured_adapter_max_input_tokens`@32768 | `engineering_preflight` | `A1.2` | `32768` | `3` | `synthetic_sentence_transformer_adapter_candidates` | `owner_local_provider_closeout` |
| `vast_v9_checkpoint_resume_pass`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `synthetic_worker_checkpoint_resume_receipt` | `owner_local_provider_closeout` |

Fixture values are synthetic engineering diagnostics and are never reported as measured performance.

## Result

**Output:** The preserved v1-v8 contracts validate, the immutable v2 fixture records 4 synthetic workers, and the additive v9 live synthetic result is PASS for attempt a12-v9-20260807-06. It preserves repair evidence for v6-initial-wheelhouse-missing-pydantic; v6-supplement-repair-mutated-pycache-tree; v7-frozen-bundle-missing-validation-lineage; provider closeout v10 is PASS.

**Result:** A1.2 synthetic live preflight status is PASS: 4 dense-arm adapter receipts were collected, Qwen measured adapter maximum is 32768 tokens, guest teardown is PASS, and the Owner-confirmed provider closeout is recorded. Scientific launch remains locked; measured runs and charged USD counters remain zero.
...
Status: **blocked**. A1.2 synthetic live preflight status is PASS: 4 dense-arm adapter receipts were collected, Qwen measured adapter maximum is 32768 tokens, guest teardown is PASS, and the Owner-confirmed provider closeout is recorded. Scientific launch remains locked; measured runs and charged USD counters remain zero.
