...
|---|---|---|---:|---:|---|---|
| `owner_local_cpu_preflight_blocker_count`@0 | `engineering_preflight` | `A1.2` | `10` | `1` | `pending_owner_launch_checklist_items` | `live_engineering_preflight_repair` |
| `vast_v2_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `16` | `1` | `frozen_live_owner_checklist_items` | `live_engineering_preflight_repair` |
| `vast_v2_synthetic_worker_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `completed_synthetic_worker_processes` | `live_engineering_preflight_repair` |
| `vast_v2_synthetic_parallel_launch_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `synthetic_workers_started_in_parallel` | `live_engineering_preflight_repair` |
| `vast_v2_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `live_engineering_preflight_repair` |
| `vast_v2_estimated_instance_hours_min`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `planning_estimate_not_authorization` | `live_engineering_preflight_repair` |
| `vast_v2_estimated_instance_hours_max`@0 | `engineering_preflight` | `A1.2` | `4` | `1` | `planning_estimate_not_authorization` | `live_engineering_preflight_repair` |
| `vast_v2_estimated_raw_worker_usd_min`@0 | `engineering_preflight` | `A1.2` | `1.2` | `1` | `planning_estimate_not_authorization` | `live_engineering_preflight_repair` |
| `vast_v2_estimated_raw_worker_usd_max`@0 | `engineering_preflight` | `A1.2` | `2.4` | `1` | `planning_estimate_not_authorization` | `live_engineering_preflight_repair` |
| `vast_v3_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `live_engineering_preflight_repair` |
| `vast_v3_common_screen_hard_stop_usd`@0 | `engineering_preflight` | `A1.2` | `18` | `1` | `hard_stop_not_spend_authorization` | `live_engineering_preflight_repair` |
| `vast_v5_direct_base_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `21` | `1` | `direct_base_live_preflight_checks` | `live_engineering_preflight_repair` |
| `vast_v5_custom_local_docker_build_removed`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `active_direct_base_path` | `live_engineering_preflight_repair` |
| `vast_v6_live_quote_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.656` | `1` | `quoted_complete_four_rtx3090_instance_not_spend_authorization` | `live_engineering_preflight_repair` |
| `vast_v6_synthetic_preflight_only`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `live_correction_authorization_boundary` | `live_engineering_preflight_repair` |
| `vast_v7_preserved_live_failure_count`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `preserved_same_instance_repair_failures` | `live_engineering_preflight_repair` |
| `vast_v7_bytecode_suppression_required`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `fresh_same_instance_repair_root` | `live_engineering_preflight_repair` |

Fixture values are synthetic engineering diagnostics and are never reported as measured performance.

## Result

**Output:** The preserved v1-v6 contracts validate, the earlier CPU-only Owner preflight remains blocked_owner_input with 10 blocker group(s), the immutable v2 fixture records 4 synthetic workers, and v7 same-instance repair preparation is same_instance_repair_prepared_preflight_pending. It preserves repair evidence for v6-initial-wheelhouse-missing-pydantic; v6-supplement-repair-mutated-pycache-tree, requires a fresh repair root and bytecode suppression, and leaves continuation conditional.
...
- `v6-initial-wheelhouse-missing-pydantic` -> `preserved_live_failure_repaired_by_hash_validated_supplement`; status `preserved_and_repaired_preflight_pending`; counters changed `False`; failure `campaigns/armindex-multiretriever-v2/evidence/a1.2-live-preflight-repair.receipt.v7.json` / `8790fca3ff8a5d4a0cdfa19d41c0534df00b3ae6d2597455b89b290ba4f39edd`; recovery `campaigns/armindex-multiretriever-v2/evidence/a1.2-live-preflight-repair.receipt.v7.json` / `8790fca3ff8a5d4a0cdfa19d41c0534df00b3ae6d2597455b89b290ba4f39edd`
- `v6-supplement-repair-mutated-pycache-tree` -> `preserved_live_failure_repaired_by_new_root_and_bytecode_suppression`; status `preserved_and_repaired_preflight_pending`; counters changed `False`; failure `campaigns/armindex-multiretriever-v2/evidence/a1.2-live-preflight-repair.receipt.v7.json` / `8790fca3ff8a5d4a0cdfa19d41c0534df00b3ae6d2597455b89b290ba4f39edd`; recovery `campaigns/armindex-multiretriever-v2/evidence/a1.2-live-preflight-repair.receipt.v7.json` / `8790fca3ff8a5d4a0cdfa19d41c0534df00b3ae6d2597455b89b290ba4f39edd`
