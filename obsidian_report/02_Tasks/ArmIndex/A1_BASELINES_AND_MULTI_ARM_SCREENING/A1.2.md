...
|---|---|---|---:|---:|---|---|
| `owner_local_cpu_preflight_blocker_count`@0 | `engineering_preflight` | `A1.2` | `10` | `1` | `pending_owner_launch_checklist_items` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `16` | `1` | `frozen_live_owner_checklist_items` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_synthetic_worker_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `completed_synthetic_worker_processes` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_synthetic_parallel_launch_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `synthetic_workers_started_in_parallel` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_estimated_instance_hours_min`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `planning_estimate_not_authorization` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_estimated_instance_hours_max`@0 | `engineering_preflight` | `A1.2` | `4` | `1` | `planning_estimate_not_authorization` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_estimated_raw_worker_usd_min`@0 | `engineering_preflight` | `A1.2` | `1.2` | `1` | `planning_estimate_not_authorization` | `scientific_execution_adoption_request_preparation` |
| `vast_v2_estimated_raw_worker_usd_max`@0 | `engineering_preflight` | `A1.2` | `2.4` | `1` | `planning_estimate_not_authorization` | `scientific_execution_adoption_request_preparation` |
| `vast_v3_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `scientific_execution_adoption_request_preparation` |
| `vast_v3_common_screen_hard_stop_usd`@0 | `engineering_preflight` | `A1.2` | `18` | `1` | `hard_stop_not_spend_authorization` | `scientific_execution_adoption_request_preparation` |
| `vast_v5_direct_base_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `21` | `1` | `direct_base_live_preflight_checks` | `scientific_execution_adoption_request_preparation` |
| `vast_v5_custom_local_docker_build_removed`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `active_direct_base_path` | `scientific_execution_adoption_request_preparation` |
| `vast_v6_live_quote_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.656` | `1` | `quoted_complete_four_rtx3090_instance_not_spend_authorization` | `scientific_execution_adoption_request_preparation` |
| `vast_v6_synthetic_preflight_only`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `live_correction_authorization_boundary` | `scientific_execution_adoption_request_preparation` |
| `vast_v7_preserved_live_failure_count`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `preserved_same_instance_repair_failures` | `scientific_execution_adoption_request_preparation` |
| `vast_v7_bytecode_suppression_required`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `fresh_same_instance_repair_root` | `scientific_execution_adoption_request_preparation` |
| `vast_v8_preserved_live_failure_count`@0 | `engineering_preflight` | `A1.2` | `3` | `1` | `preserved_validation_complete_bundle_failure_history` | `scientific_execution_adoption_request_preparation` |
| `vast_v8_validation_lineage_complete`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `frozen_bundle_historical_validator_lineage` | `scientific_execution_adoption_request_preparation` |
| `vast_v9_required_lifecycle_control_count`@0 | `engineering_preflight` | `A1.2` | `6` | `1` | `hash_bound_execution_lifecycle_controls` | `scientific_execution_adoption_request_preparation` |
| `vast_v9_implementation_validation_complete`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `additive_v9_runtime_and_orchestration_revision` | `scientific_execution_adoption_request_preparation` |
| `vast_v9_live_arm_pass_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `four_synthetic_gpu_worker_arm_receipts` | `scientific_execution_adoption_request_preparation` |
| `vast_v9_qwen_measured_adapter_max_input_tokens`@32768 | `engineering_preflight` | `A1.2` | `32768` | `3` | `synthetic_sentence_transformer_adapter_candidates` | `scientific_execution_adoption_request_preparation` |
| `vast_v9_checkpoint_resume_pass`@0 | `engineering_preflight` | `A1.2` | `1` | `1` | `synthetic_worker_checkpoint_resume_receipt` | `scientific_execution_adoption_request_preparation` |
| `v11_workload_manifest_count`@0 | `request_preparation` | `A1.2` | `5` | `5` | `frozen_five_arm_request_manifests` | `scientific_execution_adoption_request_preparation` |
| `v11_expected_program_arm_runs`@0 | `request_preparation` | `A1.2` | `25` | `25` | `planned_logical_program_arm_results_not_measured_runs` | `scientific_execution_adoption_request_preparation` |
| `v11_expected_physical_program_view_paths`@0 | `request_preparation` | `A1.2` | `35` | `35` | `planned_physical_program_view_paths_not_measured_runs` | `scientific_execution_adoption_request_preparation` |
| `v11_rep_dev_query_count`@0 | `request_preparation` | `A1.2` | `150` | `150` | `protected_rep_dev_count_commitment` | `scientific_execution_adoption_request_preparation` |
| `v11_harness_dev_reserved_count`@0 | `request_preparation` | `A1.2` | `100` | `100` | `protected_harness_dev_reservation_count` | `scientific_execution_adoption_request_preparation` |
| `v11_pending_adoption_requirement_count`@0 | `request_preparation` | `A1.2` | `9` | `1` | `fail_closed_owner_adoption_requirements` | `scientific_execution_adoption_request_preparation` |
| `v11_a1_total_usd`@0 | `request_preparation` | `A1.2` | `23` | `1` | `hard_stop_not_spend_authorization` | `scientific_execution_adoption_request_preparation` |
| `v11_campaign_usd`@0 | `request_preparation` | `A1.2` | `100` | `1` | `hard_stop_not_spend_authorization` | `scientific_execution_adoption_request_preparation` |
| `v11_common_screen_usd`@0 | `request_preparation` | `A1.2` | `18` | `1` | `hard_stop_not_spend_authorization` | `scientific_execution_adoption_request_preparation` |
| `v12_r3_pending_live_provider_input_count`@0 | `adoption_input_preparation` | `A1.2` | `4` | `1` | `fresh_identity_quote_budget_and_admission_receipt_required` | `scientific_execution_adoption_request_preparation` |
| `v13_out_recall_at_100_primary_metric_binding`@100 | `publication_preregistration` | `A1.2` | `1` | `1` | `candidate_exposure_primary_development_outcome_not_measured_result` | `scientific_execution_adoption_request_preparation` |
| `v13_current_live_instance_present`@0 | `instance_disposition_policy` | `A1.2` | `0` | `1` | `current_provider_instance_not_reuse_eligibility` | `scientific_execution_adoption_request_preparation` |

Fixture values are synthetic engineering diagnostics and are never reported as measured performance.

## Result

**Output:** The preserved v1-v10 contracts validate, the immutable v2 fixture records 4 synthetic workers, and the additive v9 live synthetic result is PASS for attempt a12-v9-20260807-06. It preserves repair evidence for v6-initial-wheelhouse-missing-pydantic; v6-supplement-repair-mutated-pycache-tree; v7-frozen-bundle-missing-validation-lineage; provider closeout v10 is PASS, request v11 is prepared for Owner review, and v12-r3 local adoption inputs are validated.

**Result:** A1.2 v11 freezes 5 workloads, 25 required logical results, 35 physical program-view paths, and 150 REP-DEV queries while reserving 100 for HARNESS-DEV. V12-r3 preserves the unchanged workload and leaves the actual 25/25 protected compiled bindings, clean pushed bundle, and 4 fresh live-provider inputs pending. It is not adopted; scientific launch remains locked and measured runs and charged USD counters remain zero.
...
Status: **blocked**. A1.2 v11 freezes 5 workloads, 25 required logical results, 35 physical program-view paths, and 150 REP-DEV queries while reserving 100 for HARNESS-DEV. V12-r3 preserves the unchanged workload and leaves the actual 25/25 protected compiled bindings, clean pushed bundle, and 4 fresh live-provider inputs pending. It is not adopted; scientific launch remains locked and measured runs and charged USD counters remain zero.
