...
The A1.1 receipt anchors a validated A1.2 offline scaffold. ARM-01 bm25s rank parity was checked on synthetic CPU inputs; four public dense source revisions, critical artifact commitments, a hash-bound budget, execution envelope, launch checklist, two-layer shutdown plan, receipt, and ledger were frozen. Launch remains false pending Owner-local artifact manifests, parity, live quote/capacity, external termination dry run, and explicit adoption.
...
|---|---|---|---:|---:|---|---|
| `owner_local_cpu_preflight_blocker_count`@0 | `engineering_preflight` | `A1.2` | `10` | `1` | `pending_owner_launch_checklist_items` | `engineering_preflight_scaffold` |
| `vast_v2_live_check_pending_count`@0 | `engineering_preflight` | `A1.2` | `16` | `1` | `frozen_live_owner_checklist_items` | `engineering_preflight_scaffold` |
| `vast_v2_synthetic_worker_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `completed_synthetic_worker_processes` | `engineering_preflight_scaffold` |
| `vast_v2_synthetic_parallel_launch_count`@0 | `engineering_preflight` | `A1.2` | `4` | `4` | `synthetic_workers_started_in_parallel` | `engineering_preflight_scaffold` |
| `vast_v2_planning_rate_usd_per_instance_hour`@0 | `engineering_preflight` | `A1.2` | `0.6` | `1` | `complete_four_rtx3090_instance` | `engineering_preflight_scaffold` |
| `vast_v2_estimated_instance_hours_min`@0 | `engineering_preflight` | `A1.2` | `2` | `1` | `planning_estimate_not_authorization` | `engineering_preflight_scaffold` |
| `vast_v2_estimated_instance_hours_max`@0 | `engineering_preflight` | `A1.2` | `4` | `1` | `planning_estimate_not_authorization` | `engineering_preflight_scaffold` |
| `vast_v2_estimated_raw_worker_usd_min`@0 | `engineering_preflight` | `A1.2` | `1.2` | `1` | `planning_estimate_not_authorization` | `engineering_preflight_scaffold` |
| `vast_v2_estimated_raw_worker_usd_max`@0 | `engineering_preflight` | `A1.2` | `2.4` | `1` | `planning_estimate_not_authorization` | `engineering_preflight_scaffold` |

Fixture values are synthetic engineering diagnostics and are never reported as measured performance.

## Result

**Output:** The preserved v1 contract scaffold validates, the earlier CPU-only Owner preflight remains blocked_owner_input with 10 blocker group(s), and the additive v2 local-orchestrated four-RTX3090 revision validates with 4 of 4 synthetic workers completed and 16 live checks pending.
