...
| `a2_provider_admissions`@0 | `premeasurement` | `A2 execution readiness` | `1` | `1` | `current_attempt` | `engineering_validation` |
...
- The Official Codex bridge and immutable A2 candidate universe are validated for model gpt-5.6-sol: 40 matched and 12 dormant reserve candidates, with compile-twice replay and freeze-lock bindings. (evidence: a2-five-arm-candidate-manifest-v1, a2-five-arm-candidate-freeze-receipt-v1, a2-five-arm-candidate-freeze-lock-v1, a2-official-codex-smoke-receipt-v2, a2-official-credit-preflight-receipt-v1, a2-official-credit-closeout-correction-v1, a2-independent-freeze-audit-v1, a2-official-final-credit-check-v1, a2-execution-readiness-contract-v2, a2-execution-readiness-envelope-v2, a2-execution-readiness-budget-v1, a2-execution-readiness-runbook-v1, a2-execution-readiness-ledger-v1, a2-source-goal-goal003-stop-v1, a2-source-lo-handoff-goal003-stop-v1, a2-source-audit-goal003-stop-v1, a2-research-session-goal003-stop-v1)
