...
# A4_PRODUCTION_TRANSFER_AND_SELECTION / A4.1
...
Production profiles and legal transfer
...
**Result:** A4_PRODUCTION_TRANSFER_AND_SELECTION is planned; ArmIndex measured runs, Selection, and Final counters remain zero.
...
Status: **planned**. A4_PRODUCTION_TRANSFER_AND_SELECTION is planned; ArmIndex measured runs, Selection, and Final counters remain zero.
