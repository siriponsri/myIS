...
- Status: `a1_2_live_preflight_execution_lifecycle_prepared_launch_locked`
...
| `ARM-02` | `BAAI/bge-m3` | v9_attempt_scoped_synthetic_gpu_preflight_pending | not_started | commercial_capable |
| `ARM-03` | `datalyes/patembed-large` | v9_attempt_scoped_synthetic_gpu_preflight_pending | not_started | research_non_commercial |
| `ARM-04` | `Snowflake/snowflake-arctic-embed-m-v2.0` | v9_attempt_scoped_synthetic_gpu_preflight_pending | not_started | commercial_capable |
| `ARM-05` | `Qwen/Qwen3-Embedding-0.6B` | v9_attempt_scoped_synthetic_gpu_preflight_pending | not_started | commercial_capable |
