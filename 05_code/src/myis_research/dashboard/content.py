...
DOCUMENTS = (
    ...
    ("owner-gates", "Owner Gate authority", "process", "00_governance/OWNER_GATES.md"),
    ("operations", "Local operations", "process", "00_governance/OPERATIONS.md"),
    ("toolchain", "Toolchain and authority", "tools", "00_governance/TOOLCHAIN.md"),
    ("tool-bootstrap", "Tool bootstrap status", "tools", "00_governance/TOOL_BOOTSTRAP_STATUS.md"),
