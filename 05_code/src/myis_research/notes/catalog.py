...
NOTE_ROOT = Path("07_obsidian_note/generated")
...
def build_notes(repository_root: Path) -> dict[str, Any]:
    ...
    notes = {
        ...
        "f1-1-cpu-sprint": (
            ...
            ["05_code/src/myis_research/harness/f1_baselines.py", "05_code/tests/test_f1_cpu_scaffold.py"],
        ...
        "track-s-protocol": (
            ...
            ["FULL_RESEARCH_TRACK_PLAN.md", "00_governance/IS_RESEARCH_TRACK_S_V0.1_SKILLOPT_HARNESSOPT_PLAN.md", "05_code/src/myis_research/harness/track_s.py"],
