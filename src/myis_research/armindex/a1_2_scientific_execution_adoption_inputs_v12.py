...
_BUNDLE_EXCLUDED_FILES = frozenset(
    {
        ...
        "control/armindex/a1.2/promotion-policy.v16.json",
        ...
        # ArmIndex A2/A3 closeout and status additions are later lineage; keep
        # the historical v12 dependency closure hash-bound to its 68308c26 set.
        "src/myis_research/armindex/a2_publication_figures.py",
        ...
        "src/myis_research/armindex/a2_result_integrity_audit.py",
        "src/myis_research/armindex/a2_three_primary_closeout.py",
        "src/myis_research/armindex/a3_bundle.py",
        "src/myis_research/armindex/a3_execution_preparation.py",
        "src/myis_research/armindex/a3_three_primary_execution.py",
        "src/myis_research/armindex/a3_three_primary_preparation.py",
        "src/myis_research/armindex/a3_three_primary_train_headroom.py",
        "src/myis_research/armindex/a3_train_headroom.py",
        "src/myis_research/status_cli.py",
        ...
        "schemas/armindex/a1.2-admitted-all-fee-quote-receipt.v16.json",
        "schemas/armindex/a1.2-cell-performance-failure-metrics.v16.json",
        "schemas/armindex/a1.2-cell-performance-metrics.v16.json",
        "schemas/armindex/a1.2-cell-eda-package.v16.json",
        "schemas/armindex/a1.2-current-attempt-pointer.v16.json",
        "schemas/armindex/a1.2-evaluator-closeout-receipt.v16.json",
        "schemas/armindex/a1.2-live-execution-adoption-receipt.v16.json",
        "schemas/armindex/a1.2-live-management-dry-run-receipt.v16.json",
        "schemas/armindex/a1.2-live-provider-admission-receipt.v16.json",
        "schemas/armindex/a1.2-live-provider-identity-receipt.v16.json",
        "schemas/armindex/a1.2-live-ssh-runtime-receipt.v16.json",
        "schemas/armindex/a1.2-measured-result-summary.v16.json",
        "schemas/armindex/a1.2-owner-local-cell-commit.v16.json",
        "schemas/armindex/a1.2-promotion-policy.v16.json",
        "schemas/armindex/a1.2-provider-continuation-receipt.v16.json",
        "schemas/armindex/a1.2-provider-disposition-receipt.v16.json",
        "schemas/armindex/a1.2-scientific-safe-return-contract.v16.json",
        "schemas/armindex/a1.2-terminal-attempt-receipt.v16.json",
        ...
        "scripts/a1_2_vast/Invoke-A12GovernedWatchdogV16R2.ps1",
        "scripts/a1_2_vast/Watch-A12ProgressV16.py",
        "scripts/a1_2_vast/remote-bootstrap-measured-v16.sh",
        "scripts/a1_2_vast/vastai-raw-compat-v16.cmd",
        ...
        "src/myis_research/armindex/a1_2_a2_baseline_handoff_v16.py",
        "src/myis_research/armindex/a1_2_cell_eda_package_v16.py",
        "src/myis_research/armindex/a1_2_live_admission_v16.py",
        "src/myis_research/armindex/a1_2_measured_executor_v16.py",
        "src/myis_research/armindex/a1_2_measured_result_summary_v16.py",
        "src/myis_research/armindex/a1_2_owner_local_cli_v16.py",
        "src/myis_research/armindex/a1_2_owner_local_evaluation_manifest_builder_v16.py",
        "src/myis_research/armindex/a1_2_owner_local_evaluation_manifest_quote_bridge_v16.py",
        ...
        "src/myis_research/armindex/a1_2_provider_continuation_v16.py",
        "src/myis_research/armindex/a1_2_provider_disposition_v16.py",
        ...
        "src/myis_research/armindex/a1_2_terminal_attempt_v16.py",
        "src/myis_research/armindex/a1_2_thai_closeout_projection_v16.py",
        "src/myis_research/armindex/a1_2_whole_workload_budget_extension_v16.py",
        "src/myis_research/armindex/a1_2_whole_workload_budget_extension_v17.py",
        "src/myis_research/armindex/a2_candidate_freeze.py",
        "src/myis_research/armindex/a2_candidate_freeze_artifacts.py",
        "src/myis_research/armindex/a2_deployment_package.py",
        "src/myis_research/armindex/a2_entry_preflight_v16.py",
