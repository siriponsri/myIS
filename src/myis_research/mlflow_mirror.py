...
class MirrorStage(StrEnum):
    ...
    A7_SEVEN_LAYER_RETRIEVAL_DIAGNOSIS = "A7_SEVEN_LAYER_RETRIEVAL_DIAGNOSIS"
    A8_JOURNAL_SYNTHESIS_AND_PUBLICATION = "A8_JOURNAL_SYNTHESIS_AND_PUBLICATION"
    ...
    def experiment_name(self) -> str:
        return {
            ...
            MirrorStage.A7_SEVEN_LAYER_RETRIEVAL_DIAGNOSIS: ARMINDEX_EXPERIMENT,
            MirrorStage.A8_JOURNAL_SYNTHESIS_AND_PUBLICATION: ARMINDEX_EXPERIMENT,
        }[self]
