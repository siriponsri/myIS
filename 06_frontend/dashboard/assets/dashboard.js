...
function renderTask(task, open) {
  ...
  appendDefinition(list, "Inputs", task.inputs);
  appendDefinition(list, "Outputs", task.outputs);
  appendDefinition(list, "Tests", task.tests);
  ...
  appendDefinition(list, "Risk", task.risk);
  appendDefinition(list, "Evidence contract", task.evidence_contract);
