...
|---|---|---|---|---|
| `APP-DAPFAM-PROTECTED` | protected_dataset | `reuse` | P0_FOUNDATION, P1_CPU_BASELINE, P2_SCOPE_DEVELOPMENT | owner_local_only |
| `APP-DAPFAM-TEXT-PRIMITIVES` | source_code | `adapt` | P0_FOUNDATION, P1_CPU_BASELINE | none |
