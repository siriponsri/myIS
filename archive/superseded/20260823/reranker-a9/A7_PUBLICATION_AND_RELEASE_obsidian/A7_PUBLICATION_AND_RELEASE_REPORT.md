...
note_id: "A7_PUBLICATION_AND_RELEASE-MASTER"
...
Build publication and release artifacts from validated aggregate-safe A0-A6 evidence only after D3_SUBMIT_RELEASE.
...
**Result:** A7_PUBLICATION_AND_RELEASE is blocked; ArmIndex measured runs, Selection, and Final counters remain zero.
...
Status: **blocked**. A7_PUBLICATION_AND_RELEASE is blocked; ArmIndex measured runs, Selection, and Final counters remain zero.
