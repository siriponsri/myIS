...
EVIDENCE_CATALOG_PATH = "evidence/catalog.v1.yaml"
MLFLOW_CATALOG_PATH = "control/campaigns/scope-autoindex-v1.yaml"
LINEAR_PROJECTION_PATH = "control/campaigns/scope-autoindex-v1.yaml"
DASHBOARD_REGISTRY_PATH = "dashboard/content_registry.yaml"
...
class ProjectionBinding(StrictModel):
    canonical_plan: Literal["control/layout.v2.yaml"]
    plan_sha256: str
    dashboard_registry: Literal["dashboard/content_registry.yaml"]
    linear_projection: Literal["control/campaigns/scope-autoindex-v1.yaml"]
