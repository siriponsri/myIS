...
def _doctor(research_root: Path, mlflow_root: Path) -> dict[str, object]:
    checks = {
        ...
        "source_package": (research_root / "src" / "myis_research").is_dir(),
...
def build_parser() -> argparse.ArgumentParser:
    ...
    dapfam.add_argument("--manifest", type=Path, help="draft RunSpec YAML under campaigns/scope-autoindex-v1/specs")
    dapfam.add_argument(
        "--dry-run",
        "--validate-draft",
        dest="validate_draft",
