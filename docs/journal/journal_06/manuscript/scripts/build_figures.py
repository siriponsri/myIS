"""Build aggregate-safe artwork for the RCRS WPI V0.6 manuscript.
...
def fig3_final():
    ...
    ax1.scatter(static, y, s=31, facecolors=WHITE, edgecolors=GREY, linewidths=1.1, marker="o", label="FAST", zorder=3)
